...
shapiro.test(corr_dt$Crass_gc_100)
# p = 0.4255
kruskal.test(corr_dt$Crass_gc_100, corr_dt$Site_Name)
# p = 0.01751
kruskal.test(corr_dt$Crass_gc_100, corr_dt$Week)
# p = 0.9042

cor.test(corr_dt$Crass_gc_100, corr_dt$gc_100ml, method = "spearman", use = "complete.obs")
# p = 0.8341
